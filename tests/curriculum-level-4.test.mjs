...
// Modules 1-3 (see docs/curriculum-level-4-upper-intermediate.md's
// module map; Modules 4-10 are mapped but not yet authored/seeded).
...
check('Level IV has the 3 modules built so far (Modules 1-3)', units.length === 3);
...
check('Every quiz question across all built Level IV modules was verified against its real seeded answer key', totalQuestionsChecked === 30);
