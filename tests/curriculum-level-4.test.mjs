...
// Modules 1-6 (see docs/curriculum-level-4-upper-intermediate.md's
// module map; Modules 7-10 are mapped but not yet authored/seeded).
...
check('Level IV has the 6 modules built so far (Modules 1-6)', units.length === 6);
...
check('Every quiz question across all built Level IV modules was verified against its real seeded answer key', totalQuestionsChecked === 60);
