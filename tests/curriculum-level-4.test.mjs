...
// Covers Level IV (Upper Intermediate Programme, B2) — all 10
// modules, fully authored and seeded. Same pattern as
// tests/curriculum-level-3.test.mjs: sweep every seeded module,
...
check('Level IV has all 10 modules built', units.length === 10);
...
check('Every quiz question across all 10 Level IV modules was verified against its real seeded answer key', totalQuestionsChecked === 110);
