...
// 1-3 (see docs/curriculum-level-3-intermediate.md's module map;
...
check('Level III has the 3 modules built so far (Modules 1-3)', units.length === 3);
...
check('Every quiz question across all built Level III modules was verified against its real seeded answer key', totalQuestionsChecked === 30);
