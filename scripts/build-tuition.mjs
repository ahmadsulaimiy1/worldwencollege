...
const L = {
  en: {
    ...
    schedNote: 'These are the only charges the College levies. There is no application fee, no registration fee, no examination fee, no re-sit fee, no instalment charge, no technology fee, no library fee, no graduation fee and no withdrawal charge. If a cost is not in the left-hand list, it does not exist.',
  },
  ar: {
    label: 'التفصيل', num: '٢',
    ...
    schedNote: 'هذه هي الرسوم الوحيدة التي تتقاضاها الكلية. لا رسم تقديم، ولا رسم تسجيل، ولا رسم امتحان، ولا رسم إعادة، ولا رسم تقسيط، ولا رسم تقني، ولا رسم مكتبة، ولا رسم تخرّج، ولا رسم انسحاب. وما ليس في القائمة اليمنى فلا وجود له.',
  },
};
