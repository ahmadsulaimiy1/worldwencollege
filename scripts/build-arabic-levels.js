 ...
 * "Certificate in Applied English Communication" would create a
...
const money = (c) => ltr(`$${(c / 100).toLocaleString('en-GB', { minimumFractionDigits: c % 100 === 0 ? 0 : 2, maximumFractionDigits: 2 })}`);
