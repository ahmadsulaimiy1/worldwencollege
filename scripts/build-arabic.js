...
<section class="section--light section-pad" id="visas" data-contents="التأشيرات">
  <div class="container reveal">
    ...
    <div class="grid grid--3">
${card('لماذا', 'لأنها تُدرّس عن بُعد', 'تأشيرات الدراسة وُجدت لإتاحة الحضور الجسدي للدراسة. برنامج ⁦IEFC⁩ لا يتضمن حضورًا جسديًا في أي مكان — لا يوجد حرم يُحضَر إليه. التأشيرة ليست محجوبة؛ هي ببساطة ليست جزءًا من طبيعة هذا البرنامج.')}
...
${darkCard('لا يستطيع', 'أن يحل محل مؤهل معترف به', 'لم يُعيَّن ممتحن خارجي ولا تحمل الكلية اعتمادًا، فلا ينبغي لأحد أن يعتمد على شهادة ⁦IEFC⁩ كمؤهل قبول أو هجرة. هذا هو الموقف الصريح، ولن يتغيّر إلا حين يتغيّر فعلًا.')}
    </div>
  </div>
</section>
...
PAGES.careers = {
  ...
  <div class="container">
    ...
    <div class="btn-row">
      <a href="mailto:info@worldwencollege.co.uk?subject=Interest%20in%20a%20post%20at%20WEC" class="btn btn--gold">أبدِ اهتمامك</a>
    </div>
  </div>
</section>
...
PAGES.tuition = {
  ...
  <div class="container">
    ...
    <h1>تسعير شفاف لمسار ⁦IEFC⁩ كاملًا.</h1>
    ...
    <div class="table-scroll">
      <table class="ledger">
        ...
        <tbody>
          ...
          <tr><td colspan="2"><strong>الإجمالي عند الدفع مستوى بمستوى</strong></td><td>120</td><td>1,200 ساعة</td><td><strong>19,000.02$</strong></td></tr>
          <tr><td colspan="4"><strong>الإجمالي عند الدفع دفعة واحدة</strong></td><td><strong>19,000$</strong></td></tr>
        </tbody>
      </table>
    </div>
    <p class="form-note"><strong>السنتان فرق حقيقي، وهذا الجدول كان يخفيهما.</strong>
      مبلغ 19,000$ لا يقبل القسمة على ستة قسمة تامة: السدس يساوي 316,666&frac23; سنتًا، ويُنشر
      3,166.67$ لأن السعر يجب أن يكون قابلاً للدفع بسنتات كاملة. ستة من هذه المبالغ تساوي
      19,000.02$، أي أن الدفع مستوى بمستوى يكلّف سنتين أكثر من الدفع دفعة واحدة. حتى الآن كان
      العمود يعرض ستة صفوف بقيمة 3,166.67$ فوق إجمالي 19,000$، وهو حساب لا يستقيم &mdash; أمر صغير،
      ومن النوع الذي يخبر القارئ المدقّق بحجم ما ينبغي التحقق منه أيضًا. تفضّل الكلية أن تعرض
      عليك الحساب بدل أن تُخفيه بالتقريب.</p>
...
PAGES.faq = {
  ...
  <div class="container">
    ...
    <p class="lede">كل ما تحتاج معرفته عن برنامج ⁦IEFC⁩، والقبول، والدراسة في الكلية.</p>
  </div>
</section>
  ...
  <div class="container reveal" style="max-width:820px">
    <div class="accordion">
      ...
      <div class="accordion__item">
        ...
        <div class="accordion__a"><div class="accordion__a-inner">نعم، بالكامل. تقدّم الكلية برنامج ⁦IEFC⁩ عبر حرم رقمي — دروس مُدرَّجة، ومختبر الاستماع، وتكاليف يصححها شخص، وسجلك الأكاديمي — بحيث يمكن لأي طالب حول العالم الالتحاق دون الحاجة للانتقال. أما الحصص المباشرة فمصمَّمة ولم تُعقد بعد لأن أي دفعة لم تُدرَّس، والتسجيلات الصوتية لعمل الاستماع لم تُنتج. يُذكر الأمران لا يُوهَمان.</div></div>
      </div>
      ...
      <div class="accordion__item">
        <button class="accordion__q"><span>لمن صُمم برنامج ⁦IEFC⁩؟</span><span class="plus" aria-hidden="true">+</span></button>
      ...
      <div class="accordion__item">
        ...
        <div class="accordion__a"><div class="accordion__a-inner">يُصدَر كشف درجات رقمي بعد كل مستوى. أما شهادة ⁦IEFC⁩ نفسها فلا يمكن منحها بعد: منح الشهادة يتطلب ممتحنًا خارجيًا، ولم يُعيَّن أحد. حين يبدأ المنح، تُصدَر شهادة رقمية عند إتمام البرنامج كاملًا بنجاح، مع النسخة المطبوعة والتحقق كخدمتين اختياريتين.</div></div>
      </div>
...
${card('س', 'هل سأحصل على شهادة؟', 'يُصدَر كشف درجات بعد كل مستوى. أما شهادة ⁦IEFC⁩ نفسها فلا يمكن منحها بعد: لم يُعيَّن ممتحن خارجي، ومنح شهادة دون فحص خارجي يجعلها أقل قيمة لا أكثر. راجع <a href="/ar/governance/#quality">ضمان الجودة</a>.')}
    </div>
  </div>
</section>
...
<section class="section--light section-pad" id="iefc" data-contents="برنامج ⁦IEFC⁩">
  <div class="container reveal">
    <div class="section-head">
      <span class="module-marker">برنامج ⁦IEFC⁩</span>
