...
<section class="section--paper section-pad">
  <div class="container reveal">
    <div class="section-head">
      ...
      <h2>ما هو نافذ، وما هو مقترح.</h2>
      <p class="lede">أمران يبدوان كلاهما «درجة النجاح»، وواحد منهما فقط ساري المفعول.</p>
    </div>
    <div class="table-scroll">
      <table class="ledger">
        ...
        <tbody>
          ...
          <tr><td>نجاح عند ${ltr(PASS_PCT + '%')}، ولا مهارة دون ${ltr('60%')}</td><td>مقترحة</td>
              <td>معيار الشهادة، بانتظار الإقرار من الجهة الحاكمة. غير معتمد، ولم يُقيَّم عليه أحد.</td></tr>
          <tr><td>امتياز عند ${ltr('80%')}، ولا مهارة دون ${ltr('70%')}</td><td>مقترحة</td><td>كما سبق.</td></tr>
          <tr><td>تميّز عند ${ltr('88%')}، ولا مهارة دون ${ltr('80%')}</td><td>مقترحة</td><td>كما سبق.</td></tr>
          <tr><td>تميّز عالٍ عند ${ltr('94%')}، ولا مهارة دون ${ltr('88%')}</td><td>مقترحة</td><td>كما سبق.</td></tr>
        </tbody>
      </table>
    </div>
    <div class="callout">
...
PAGES.awards = {
  ...
  description: 'شهادات المستويات الستة ورموزها، والمراتب المقترحة، ولماذا لم تُمنح شهادة لأحد بعد.',
...
<section class="section--paper section-pad">
  <div class="container reveal">
    <div class="section-head">
      ...
      <h2>مقترحة، غير معتمدة.</h2>
      <p class="lede">النظام أدناه مكتوب ومُبرَّر. وهو بانتظار الإقرار، ولم يُطبَّق قط، ويوسم
        بأنه مقترح حيثما ظهر.</p>
    </div>
    <div class="table-scroll">
      <table class="ledger">
...
${darkCard('غير موجود', 'كل ما يتطلب طرفًا خارجيًا', 'لا اعتماد، ولا ممتحن خارجي، ولا مراجع أكاديمي، ولا أعضاء معيَّنون في الهيئتين الأكاديميتين، ولا بند دليل واحد مُقَر، ولا دفعة دُرِّست، ولا خريجون، وخمسة وعشرون قرارًا حاكمًا ما زال بانتظار من يتخذه.')}
    </div>
