...
const VOLUMES = [
  ...
  { slug: 'teachers-companion-level-1', file: "IEFC Level I Teacher's Companion.pdf",
    ...
    note_ar: 'لكل درس من دروس المستوى الأول: ما يُخطئ فيه المتعلمون عادةً، ولماذا، وطريقة ثانية للشرح، وما يُفعَل مع من تأخّر ومع من أنهى مبكرًا. وصدر الكتاب يذكر أنه لا يحتوي ملاحظة صفّية.' },
  ...
  { slug: 'listening-scripts', file: 'IEFC Listening Scripts.pdf',
    ...
    collection: 'Teaching and Assessment', audience: 'Teachers',
    note: 'All 120 listening sets in full script, with the speakers marked and the features each set targets. Published as scripts; the recorded audio requires voices and a studio.',
    note_ar: 'مجموعات الاستماع المئة والعشرون بنصوصها الكاملة، مع تحديد المتحدثين والسمات التي تستهدفها كل مجموعة. تُنشر نصوصًا؛ أما الصوت المسجَّل فيحتاج أصواتًا واستوديو.' },
...
// is locked.
const served = rows.filter((r) => !r.oversize && r.access === 'open');
const out = {
  _: [
    ...
    'is open, and this policy withdraws nothing: it binds the per-level',
