...
export const EXECUTED = [
  ...
  { item: 'The pedagogical record, and the 1,616 fields deliberately left empty', built: '17 '
    ...
    + 'graph. The other fourteen are what a teacher learns by teaching, and no classroom '
    + 'observation has yet been entered into this record, so 1,616 of 1,938 entries are marked '
    + 'not_yet_evidenced and carry no value. That emptiness is the deliverable: a record filled '
    + 'with plausible prose about misconceptions nobody has written down would look like '
    + 'classroom knowledge, be guesswork, and be inherited as fact by every future edition. A '
    + 'test asserts that no field is ever marked observed_in_teaching before an observation is '
    + 'recorded against it.' },
