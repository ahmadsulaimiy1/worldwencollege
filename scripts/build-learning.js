...
PAGES.accessibility = {
  ...
  title: 'Accessibility &mdash; Albalagh International Premium College',
  description: 'What AIPC has built for accessibility, what has not been audited, and what the '
...
PAGES.privacy = {
  ...
  title: 'Privacy &amp; Your Data &mdash; Albalagh International Premium College',
  description: 'What this site collects, what it does not, who else is involved, and the '
    + 'accountability AIPC has not yet appointed.',
...
${darkCard('Payment', 'The gateway you choose', 'Card and local payment details are entered with the payment provider, never with the College. AIPC records that a payment succeeded, its amount and its reference; it never sees or stores a card number.')}
    </div>
  </div>
</section>
