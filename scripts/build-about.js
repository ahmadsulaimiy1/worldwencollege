...
<section class="section--paper section-pad" id="coverage">
  <div class="container reveal">
    <div class="section-head">
      ...
      <p class="lede">The table above says what the six competencies are. It cannot say how much
        weight each one currently carries, and the answer is the most useful thing on this
        page.</p>
    </div>

    <!-- The wheel, drawn. BASCE's remit — quoted verbatim at the top of
         this page — says each competency is to be assessed multiple
         times across each level. The drawing measures the framework
         against that sentence and shows the polygon collapsing on the
         two axes that carry nothing, which is a thing prose can state
         but not show. Generated by
         scripts/art/generate-competency-wheel.mjs, which reads every
         figure from the competency mapping rather than carrying it as
         text. -->
    <figure class="diagram diagram--wide">
    ...
    <div class="callout">
      ...
      <p>Command and Clarity carry most of Level I. Judgement is assessed four times, Reason
        once, and Bearing and Reach are not assessed at Level I at all. Against the remit
        quoted at the top of this page &mdash; <em>each competency assessed multiple times
        across each level</em> &mdash; three of the six clear the bar today.</p>
      <p>This is published rather than smoothed for the same reason the mappings are recorded
        as interim: a framework that reports even coverage it does not have is worth less than
        one that reports uneven coverage it does. The gap is the work, and naming it is how it
        gets closed.</p>
    </div>
  </div>
</section>
...
${darkCard('Mapped', 'Level I only, so far', 'Every Level I assessment is mapped to the competencies it bears on, with a weight and a written rationale. Levels II to VI carry no competency mapping yet. Competencies are evidenced where they are genuinely assessed rather than distributed evenly to look complete.')}
...
<section class="section--light section-pad" id="two-loops">
  <div class="container reveal">
    <div class="section-head">
      <span class="module-marker">Two Loops</span>
      <h2>One turns on every change. The other has never turned.</h2>
      <p class="lede">The two sections above are not two lists of the same kind of thing. They
        are two loops running at completely different speeds, and a page can say that in a
        sentence without anybody quite seeing it.</p>
    </div>
    ...
    <!-- The cycle, drawn. The inner ring is closed and gold because the
         ...
         the more familiar lie. Generated by
