# AIPC — Executive Readiness Report
...
assumptions — most significantly, that AIPC builds and owns its LMS
...
- **Executive Decision #4 — proprietary LMS, Milestone 1.** New
  ...
  units/quizzes/assignments are AIPC academic staff's work (M2).
...
4. **LMS content authoring** — not a decision so much as a resourcing
   question: who on AIPC's academic staff authors the real Level
