# WEC — Level VI: English Mastery Programme (C2) — Full Curriculum
...
"not simply another language level — it is the capstone of the WEC
...
- **A genuine capstone, not a tenth ordinary module.** Module 10
  ...
  terminal assessment, and the deliverable a WEC graduate can show
...
most distinguishes C2 from C1 in WEC's assessment model.

**On the graduate attributes.** Your directive names eight attributes
every WEC graduate should demonstrate. Each is assessed somewhere
...
**With this level, the six-level WEC curriculum is complete** —
