# WEC — Level II: Elementary Programme (A2) — Full Curriculum
...
- **British/American English is introduced explicitly, not silently
  ...
  "correct" and the other "wrong." WEC teaches International
...
- **Contexts are authentic and contemporary, not just grammatically
  ...
  (no real named company is used or implied to endorse WEC; see
...
colour, travelled*; American *favorite, color, traveled*). WEC
