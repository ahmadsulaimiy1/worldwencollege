...
WEC was originally a fictional placeholder name used in an unrelated
...
**Name:** Worldwide English College — London Campus (WEC)
...
English-language institutions worldwide — while the WEC programme titles
...
WEC's operators supply the real data.
...
3. **Testimonials** — not written. WEC has no enrolled students yet, so
...
4. **Student Portal backend and LMS backend are both now real code; no
   ...
   to prevent; that's real WEC academic staff's work (see
