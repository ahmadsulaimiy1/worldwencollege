...
('ev_pn_001','PN-001','Data Protection','Published privacy notice','governance_pending',
 'No privacy notice is published. Learners, applicants and graduates have been told nothing about what the College holds about them, and a data subject cannot exercise a right they have never been told they have. Four determinations are needed first and none is the author''s to make: the identity of the data controller (the College''s legal status is not settled), the lawful basis for each of the eleven processing activities, nine undetermined retention periods, and the international transfer position. Board Paper 02 puts all four to the Board with options, consequences and recommendations. A draft notice is deliberately NOT written: it would carry blanks in the places that matter, and a notice with blanks looks like a commitment and is not one.',
 NULL,'internal','Registrar',NULL),
