...
('ev_gov_001','GOV-001','Governance','Register of governance decisions awaiting approval','exists',
 'The complete list of academic and operational decisions the Executive has been asked to take, each with a recommendation and the consequences of not taking it. Its header states plainly that nothing in it is adopted.',
...
('ev_gov_004','GOV-004','Governance','Schedule of delegated authority','governance_pending',
 'Who may confer an award, withdraw one, change what a learner is charged, or destroy learner work. Partially implemented in software and recorded as governance A1, A2, A4, A5 and C5; not adopted as a schedule.',
 NULL,'internal','Governing Council',NULL);
...
('ev_asr_002','ASR-002','Assessment Regulations','Pass marks and classification','governance_pending',
 'Module pass threshold, end-of-level examination pass mark, and the thresholds separating Pass, Merit, Distinction, High Distinction and Distinction of the College. Governance B1, B2 and C4b; not adopted. No award can be conferred until they are.',
 NULL,'internal','Academic Senate',NULL),
('ev_asr_003','ASR-003','Assessment Regulations','Resit and reassessment policy','governance_pending',
 'How many resits a learner may take, whether a resit mark is capped, and what happens when resits are exhausted. Governance B3; not adopted.',
 NULL,'internal','Academic Senate',NULL),
...
('ev_rr_001','RR-001','Risk Registers','Institutional risk register','governance_pending',
 ...
 NULL,'internal','Governing Council',NULL),
('ev_sf_001','SF-001','Student Feedback','Student feedback instrument','not_instrumented',
 'Nothing in the platform collects learner opinion. Any statement the College made about learner satisfaction would be unfounded. Governance A7.',
 NULL,'internal','Director of Student Affairs',NULL),
...
('ev_pol_001','POL-001','Policy Register','Data protection and retention policy','governance_pending',
 'Retention periods, erasure on request, and the conflict between a permanent tamper-evident register and a right to erasure. Drafted as governance D1, D2 and D3; not adopted. The platform ships in the safest available state — recordings are kept, never deleted, and the purge mechanism is switched off.',
...
('rel_a7_sf1','governance','A7','blocks','evidence','SF-001','approved','2026-08-04T00:00:00.000Z','Student feedback instrument.'),
