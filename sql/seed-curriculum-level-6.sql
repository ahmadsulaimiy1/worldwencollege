...
'INSTRUCTIONS: This is the final assessment of the WEC programme. It has four parts, all on a single global challenge chosen by you from the domain of GLOBAL CHALLENGES AND SUSTAINABLE DEVELOPMENT — a challenge with genuine trade-offs, on which informed people disagree.
...
A grade at or above the platform''s pass threshold marks Module 10, Level VI, and the WEC programme complete.');
