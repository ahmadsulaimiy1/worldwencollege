...
(function () {
  ...
  function renderAwards(awards) {
    ...
    awards.forEach(function (a) {
      ...
      // award was withdrawn.
      if (a.standing === 'revoked') meta.appendChild(el('span', 'status-pill status-pill--critical', T.withdrawn));
      else if (a.standing === 'replaced') meta.appendChild(el('span', 'status-pill status-pill--muted', T.superseded));
      if (a.honourLabel && a.honour !== 'pass') {
        ...
        meta.appendChild(el('span', 'status-pill status-pill--honour', pick(a.honourLabel, a.honourLabelAr)));
      }
    ...
    d.byKind.forEach(function (group) {
      ...
      group.items.forEach(function (i) {
        ...
        if (i.status === 'withdrawn') {
          meta.appendChild(el('span', 'status-pill status-pill--critical', T.withdrawn));
        }
  ...
  function renderVerification(p) {
    ...
    window.WEC_LC_data.credentialQr(a.verificationCode, AR)
      .then(function (svg) {
        var host = $('#qr');
        host.textContent = '';
